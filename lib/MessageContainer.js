...
export default class MessageContainer extends React.PureComponent {
    constructor() {
        ...
        this.detachKeyboardListeners = () => {
            var _a, _b, _c, _d;
            (_a = this.keyboardWillShowListner) === null || _a === void 0 ? void 0 : _a.remove();
            (_b = this.keyboardDidShowListner) === null || _b === void 0 ? void 0 : _b.remove();
            (_c = this.keyboardWillHideListner) === null || _c === void 0 ? void 0 : _c.remove();
            (_d = this.keyboardDidHideListner) === null || _d === void 0 ? void 0 : _d.remove();
        };
